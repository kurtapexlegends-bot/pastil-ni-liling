  ...
  return (
    <div className="max-w-md w-full mx-auto space-y-10">
      <div className="space-y-4">
        ...
        <h1 className="text-4xl font-black tracking-tighter text-brand-earth">Reset Password</h1>
        <p className="text-xs font-bold uppercase tracking-widest text-brand-earth/40">
          Enter your new password below
        </p>
      </div>

      {success ? (
        <div className="space-y-6 bg-white border border-gray-100 rounded-3xl p-8 shadow-sm text-center animate-in fade-in zoom-in duration-300">
          ...
          <h2 className="text-lg font-bold text-brand-earth">Password Updated</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              disabled
              value={email}
              className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-5 py-4 text-sm font-bold text-brand-earth/50 outline-none cursor-not-allowed shadow-inner"
            />
          </div>

          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-brand-earth/60">New Password</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-brand-earth/60">Confirm New Password</label>
            <input
              type="password"
              required
  ...
  return (
    <div className="min-h-screen bg-white flex relative">
        ...
        <div className="relative z-10 space-y-8 max-w-md">
          ...
          <div className="space-y-4">
            <h2 className="text-5xl font-black text-white tracking-tighter leading-none">
              Security First <br />
              <span className="text-brand-yellow">at Liling.</span>
            </h2>
            <p className="text-white/60 font-medium leading-relaxed">
              We protect your account data and franchise settings with strict encryption standards. Enter your new password to regain access.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-20 lg:px-24 py-12 bg-[#fafafa]">
        <Suspense fallback={<div className="text-xs text-brand-earth/50 text-center font-bold uppercase tracking-wider animate-pulse">Loading...</div>}>
          <ResetPasswordForm />
        </Suspense>
      </div>
    </div>
